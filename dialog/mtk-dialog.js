class MtkDialog {
	...
	const buttonsContainer = this.root.querySelector(".dialog-buttons");
	...
	this.config.buttons.forEach(btn => {
	    ...
	    if (btn.label === "Cancel") button.className = "btn btn-link";
	    else if (btn.class) button.classList.add(btn.class);
	...
	this.root.addEventListener("click", e => {
	    ...
	    console.log("[mtk-dialog] Publishing:", eventName);
	...
	if (message === "dialog.open") this.open();
	if (message === "dialog.close") this.close();
    }
}
