/*
 * mtk-biab.js
 * Reload-safe BIAB component.
 * Fixes: Uncaught SyntaxError: Identifier 'MtkBiab' has already been declared
 * Cause: the SPA/wc-include path can evaluate this file more than once on reload/hash route changes.
 */
(function () {
  "use strict";
  ...
  class MtkBiab {
    ...
    _init() {
      ...
      this._publish(this.events.publish.ready || "mtk-biab:ready", {
        ...
        version: this.config.version || "1.0.10"
      });
    }
