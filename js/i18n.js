...
(function (global) {
  ...
  var DICT = {
    ...
    'biab.googleSeo.body': { en: 'NALA automatically prepares the on-site SEO and Google-ready business data. Google Search Console and Google Business Profile submissions require the client to authorize the correct Google account or add NALA as a manager first.', es: 'NALA prepara automáticamente el SEO del sitio y los datos comerciales listos para Google. Los envíos a Google Search Console y al Perfil de Negocio de Google requieren que el cliente autorice la cuenta de Google correcta o agregue primero a NALA como administrador.' },
