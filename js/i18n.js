...
(function (global) {
  ...
  var DICT = {
    ...
    'settings.error.requiredFields': { en: 'Fill in every field marked with an asterisk (*), then click Save again.', es: 'Completa todos los campos marcados con asterisco (*) y luego haz clic en Guardar otra vez.' },
    'settings.error.servicesRequired': { en: 'Check at least one service you offer, or click Add another service, type the service name, leave it checked, and click Save services offered.', es: 'Marca al menos un servicio que ofreces, o haz clic en Agregar otro servicio, escribe el nombre, deja la casilla marcada y haz clic en Guardar servicios ofrecidos.' },
    ...
    'biab.error.save':           { en: 'We could not save this step. Check the required fields, then click Save again.', es: 'No pudimos guardar este paso. Revisa los campos obligatorios y luego haz clic en Guardar otra vez.' },
    'biab.error.request':        { en: 'We could not send this request. Check the information on the page, then click the button again.', es: 'No pudimos enviar esta solicitud. Revisa la información de la página y luego haz clic en el botón otra vez.' },
    'biab.error.generic':        { en: 'We could not finish that step. Check the information on the page, then try again.', es: 'No pudimos terminar ese paso. Revisa la información de la página y vuelve a intentarlo.' },
    'biab.error.reviewRequest':  { en: 'We could not send the review request email. Check that the customer email is correct, then save the invoice again.', es: 'No pudimos enviar el correo de solicitud de reseña. Revisa que el correo del cliente sea correcto y luego guarda la factura otra vez.' },
    ...
    'biab.website.previewLink': { en: 'Open the customer website preview', es: 'Abrir la vista previa del sitio del cliente' },
    'biab.card.title': { en: 'Business Card & Logo', es: 'Tarjeta de presentación y logo' },
    'biab.card.desc': { en: 'Choose the business card your customer will receive.', es: 'Elige la tarjeta de presentación que recibirá tu cliente.' },
    ...
    'biab.card.select': { en: 'Choose one business card', es: 'Elige una tarjeta de presentación' },
    'biab.card.selectHelp': { en: 'Click the card design you like. A check mark will show your choice. Then click Order this business card.', es: 'Haz clic en el diseño que te gusta. Una marca mostrará tu elección. Luego haz clic en Pedir esta tarjeta.' },
    'biab.card.order': { en: 'Order this business card', es: 'Pedir esta tarjeta' },
    ...
    'biab.googleSeo.search': { en: 'Search', es: 'Búsqueda' },
    'biab.googleSeo.desc': { en: 'Send the customer a simple email that tells them exactly how to approve Google setup.', es: 'Envía al cliente un correo sencillo que le dice exactamente cómo aprobar la configuración de Google.' },
    'biab.googleSeo.body': { en: 'Click Send Google setup email. The customer will get step-by-step instructions. NALA support will also get the business details needed for the next steps.', es: 'Haz clic en Enviar correo de configuración de Google. El cliente recibirá instrucciones paso a paso. El soporte de NALA también recibirá los datos del negocio necesarios para los siguientes pasos.' },
    'biab.googleSeo.next': { en: 'Click Send Google setup email. Then tell the customer to open the email from NALA and follow the steps in order.', es: 'Haz clic en Enviar correo de configuración de Google. Luego dile al cliente que abra el correo de NALA y siga los pasos en orden.' },
    'biab.googleAuthorization': { en: 'Google authorization', es: 'Autorización de Google' },
    'biab.googleAuthorizationDesc': { en: 'Authorize or invite NALA to the business Google account when you want us to submit Search Console and Google Business Profile updates for you.', es: 'Autoriza o invita a NALA a la cuenta comercial de Google cuando quieras que enviemos por ti las actualizaciones de Search Console y del Perfil de Negocio de Google.' },
    'biab.googleHostedSeo': { en: 'Hosted website SEO', es: 'SEO del sitio alojado' },
    'biab.googleHostedSeoDesc': { en: 'Titles, descriptions, local business schema, review schema, internal links, and sitemap-ready URLs are generated from the business profile.', es: 'Los títulos, descripciones, esquema de negocio local, esquema de reseñas, enlaces internos y URL listas para el mapa del sitio se generan desde el perfil comercial.' },
    'biab.googleHostedSeoPreparedDesc': { en: 'NALA has prepared title tags, meta descriptions, local business schema, review schema, sitemap-ready URLs, and internal links from the saved profile.', es: 'NALA preparó etiquetas de título, metadescripciones, esquema de negocio local, esquema de reseñas, URLs listas para el mapa del sitio y enlaces internos desde el perfil guardado.' },
    'biab.googleSearchConsole': { en: 'Search Console sitemap', es: 'Mapa del sitio en Search Console' },
    'biab.googleSearchConsoleDesc': { en: 'After the Google account has access to the website property, NALA can submit the sitemap through the Search Console API.', es: 'Después de que la cuenta de Google tenga acceso a la propiedad del sitio web, NALA puede enviar el mapa del sitio mediante la API de Search Console.' },
    'biab.googleSearchConsoleAuthorizeThenSubmitDesc': { en: 'The client authorizes the Google account; then NALA can submit the hosted sitemap through the Search Console API.', es: 'El cliente autoriza la cuenta de Google; después NALA puede enviar el mapa del sitio alojado mediante la API de Search Console.' },
    'biab.googleSearchConsoleAuthorizationDesc': { en: 'The client has been emailed the Google authorization steps. After authorization, NALA can submit the hosted sitemap through Search Console.', es: 'Se enviaron al cliente los pasos de autorización de Google. Después de la autorización, NALA puede enviar el mapa del sitio alojado mediante Search Console.' },
    'biab.googleBusinessProfile': { en: 'Google Business Profile', es: 'Perfil de Negocio de Google' },
    'biab.googleBusinessProfileDesc': { en: 'The owner must claim or verify the profile, then NALA can prepare and manage eligible location details with approved access.', es: 'El dueño debe reclamar o verificar el perfil; después NALA puede preparar y administrar los datos de ubicación elegibles con acceso aprobado.' },
    'biab.googleBusinessProfileOwnerVerificationDesc': { en: 'The owner must claim or verify the profile and add NALA as a manager before eligible location details can be managed.', es: 'El dueño debe reclamar o verificar el perfil y agregar a NALA como administrador antes de poder manejar los datos de ubicación elegibles.' },
    'biab.googleBusinessProfileVerificationDesc': { en: 'The client has been asked to claim or verify the Business Profile and add NALA as a manager so eligible location details can be managed.', es: 'Se pidió al cliente que reclame o verifique el Perfil de Negocio y agregue a NALA como administrador para poder manejar los datos de ubicación elegibles.' },
    'biab.localSeoPackage': { en: 'Local SEO data package', es: 'Paquete de datos de SEO local' },
    'biab.localSeoPackageDesc': { en: 'Name, phone, website, service area, hours, services, and description are kept consistent for listings and citation work.', es: 'El nombre, teléfono, sitio web, área de servicio, horario, servicios y descripción se mantienen consistentes para listados y citas.' },
    'biab.localSeoPreparedDesc': { en: 'NALA keeps the public name, phone, website, service area, hours, services, and description consistent for Google and local citation work.', es: 'NALA mantiene el nombre público, teléfono, sitio web, área de servicio, horario, servicios y descripción consistentes para Google y citas locales.' },
    'biab.googlePreparedButton': { en: 'Prepare Google SEO', es: 'Preparar SEO de Google' },
    'biab.googleSeo.preparedSuccess': { en: 'Google setup information saved. Next, send the Google setup email.', es: 'Información de configuración de Google guardada. Ahora envía el correo de configuración de Google.' },
    'biab.googleSeo.authorizationSent': { en: 'Google setup email sent. Tell the customer to open the email from NALA and follow each step in order.', es: 'Correo de configuración de Google enviado. Dile al cliente que abra el correo de NALA y siga cada paso en orden.' },
    'biab.googleSeo.startAuthorization': { en: 'Send Google setup email', es: 'Enviar correo de configuración de Google' },
    'biab.googleSeo.googleProfileLink': { en: 'Open Google Business Profile setup', es: 'Abrir configuración del Perfil de Negocio de Google' },
    'biab.googleSeo.statusHeading': { en: 'Google setup status', es: 'Estado de configuración de Google' },
    'biab.googleSeo.statusHelp': { en: 'After you click the email button, the status below shows what is ready and what the customer still needs to do.', es: 'Después de hacer clic en el botón de correo, el estado de abajo muestra qué está listo y qué debe hacer todavía el cliente.' },
    'biab.googleData': { en: 'Business details NALA will use', es: 'Datos del negocio que NALA usará' },
    'biab.lastPrepared': { en: 'Last prepared', es: 'Preparado por última vez' },
    'biab.authorizationEmailSent': { en: 'Authorization email sent', es: 'Correo de autorización enviado' },
    'biab.to': { en: 'to', es: 'a' },
    'biab.notProvided': { en: 'Not provided yet', es: 'Todavía no proporcionado' },
    'biab.automatic': { en: 'Automatic', es: 'Automático' },
    'biab.needsAuthorization': { en: 'Needs authorization', es: 'Requiere autorización' },
    ...
    'biab.googleSetupEmailedDesc': { en: 'The customer has been emailed the Google setup steps. Tell them to open the email from NALA and follow each step in order.', es: 'Se enviaron al cliente los pasos de configuración de Google. Dile que abra el correo de NALA y siga cada paso en orden.' },
    'biab.prepared': { en: 'Prepared', es: 'Preparado' },
    'biab.ready': { en: 'Ready', es: 'Listo' },
    'biab.needsCustomerAction': { en: 'Needs customer action', es: 'Requiere acción del cliente' },
    'biab.thingsYouNeedToDo': { en: 'Things you need to do', es: 'Cosas que debes hacer' },
    'biab.thingsNalaHandles': { en: 'Things NALA handles for you', es: 'Cosas que NALA hace por ti' },
    'biab.helpfulLinks': { en: 'Helpful links', es: 'Enlaces útiles' },
    ...
    'biab.googleStepApprovalDesc': { en: 'The customer must approve Google access before NALA can finish the Google steps.', es: 'El cliente debe aprobar el acceso de Google antes de que NALA pueda terminar los pasos de Google.' },
    'biab.googleStepVerification': { en: 'Business verification', es: 'Verificación del negocio' },
    'biab.googleStepVerificationDesc': { en: 'Google may ask the customer to verify by email, phone, text, video, or postcard. The email explains what to do.', es: 'Google puede pedir al cliente que verifique por correo, teléfono, texto, video o postal. El correo explica qué hacer.' },
    'biab.googleStepListing': { en: 'Local listing details', es: 'Datos para listados locales' },
    'biab.googleStepListingDesc': { en: 'NALA keeps the business name, phone, website, service area, hours, services, and description ready for listings.', es: 'NALA mantiene listos el nombre del negocio, teléfono, sitio web, área de servicio, horario, servicios y descripción para los listados.' },
    'biab.businessName': { en: 'Business Name', es: 'Nombre del negocio' },
    'biab.legalBusinessName': { en: 'Legal Business Name', es: 'Nombre legal del negocio' },
    'biab.ownerName': { en: 'Owner Name', es: 'Nombre del dueño' },
    'biab.websiteUrl': { en: 'Website Url', es: 'Enlace del sitio web' },
    ...
    'biab.startHere': { en: 'Start here', es: 'Empieza aquí' },
    ...
    'biab.businessProfileSetupDesc': { en: 'Enter the information customers should see, such as your business name, phone number, email, website, hours, and service area. Click Save when you are done.', es: 'Ingresa la información que los clientes deben ver, como el nombre del negocio, teléfono, correo, sitio web, horario y área de servicio. Haz clic en Guardar cuando termines.' },
    ...
    'biab.googleAuthorizationActionDesc': { en: 'Click the button in the Google section. The customer receives step-by-step instructions for approving Google setup.', es: 'Haz clic en el botón de la sección de Google. El cliente recibe instrucciones paso a paso para aprobar la configuración de Google.' },
    'biab.basicWebsiteStructure': { en: 'Website pages', es: 'Páginas del sitio web' },
    'biab.basicWebsiteStructureDesc': { en: 'NALA creates the customer website pages for you. After you save your business information, the website can use that information.', es: 'NALA crea las páginas del sitio para ti. Después de guardar la información del negocio, el sitio puede usar esa información.' },
    'biab.contactInformationConfiguration': { en: 'Contact details shared across BIAB', es: 'Datos de contacto compartidos en BIAB' },
    'biab.contactInformationConfigurationDesc': { en: 'After you save your phone number, email, and website, NALA uses them on the website, business cards, invoices, and review requests.', es: 'Después de guardar tu teléfono, correo y sitio web, NALA los usa en el sitio, tarjetas, facturas y solicitudes de reseña.' },
    'biab.serviceListingTemplate': { en: 'Service list', es: 'Lista de servicios' },
    'biab.serviceListingTemplateDesc': { en: 'Choose the locksmith services you offer in Profile & Settings. NALA uses that list on your website and customer materials.', es: 'Elige los servicios de cerrajería que ofreces en Perfil y configuración. NALA usa esa lista en tu sitio web y materiales para clientes.' },
    'biab.customerReviewWorkflow': { en: 'Review requests', es: 'Solicitudes de reseña' },
    'biab.customerReviewWorkflowDesc': { en: 'When you save an invoice, NALA automatically asks the customer for a review. You do not need to check a box.', es: 'Cuando guardas una factura, NALA pide automáticamente una reseña al cliente. No necesitas marcar ninguna casilla.' },
    'biab.googleWebsiteSetup': { en: 'Google website setup', es: 'Configuración del sitio para Google' },
    'biab.googleWebsiteSetupDesc': { en: 'NALA prepares your website for Google. The customer only needs to approve Google access when the email arrives.', es: 'NALA prepara tu sitio para Google. El cliente solo debe aprobar el acceso de Google cuando llegue el correo.' },
    'biab.localListingInfo': { en: 'Local listing information', es: 'Información para listados locales' },
    'biab.localListingInfoDesc': { en: 'NALA keeps your business name, phone, website, hours, service area, and services ready for local business listings.', es: 'NALA mantiene listos el nombre del negocio, teléfono, sitio web, horario, área de servicio y servicios para los listados locales.' },
    ...
    'biab.newInvoice': { en: 'Create a new invoice', es: 'Crear una factura nueva' },
    'biab.editInvoice': { en: 'Edit this invoice', es: 'Editar esta factura' },
    'biab.invoicePageHelp': { en: 'Fill in the customer and job details, then click Save invoice. NALA sends the review request automatically.', es: 'Completa los datos del cliente y del trabajo, y luego haz clic en Guardar factura. NALA envía la solicitud de reseña automáticamente.' },
    'biab.invoices.title': { en: 'Invoices', es: 'Facturas' },
    'biab.invoices.desc': { en: 'Create invoices and send review requests.', es: 'Crea facturas y envía solicitudes de reseña.' },
    'biab.invoices.body': { en: 'Click Create a new invoice to enter the customer and job details. When you save the invoice, NALA automatically sends the customer a review request.', es: 'Haz clic en Crear una factura nueva para ingresar los datos del cliente y del trabajo. Cuando guardes la factura, NALA enviará automáticamente una solicitud de reseña al cliente.' },
    'biab.invoices.next': { en: 'Click Create a new invoice. Fill in the customer name, customer email, job details, and price, then click Save invoice.', es: 'Haz clic en Crear una factura nueva. Completa el nombre del cliente, correo del cliente, detalles del trabajo y precio, y luego haz clic en Guardar factura.' },
    'biab.invoices.sortTip': { en: 'Tip: click a column name to sort the invoices. Click the same column again to reverse the order.', es: 'Consejo: haz clic en el nombre de una columna para ordenar las facturas. Haz clic otra vez en la misma columna para invertir el orden.' },
    'biab.reviews.title': { en: 'Customer Reviews', es: 'Reseñas de clientes' },
    'biab.reviews.desc': { en: 'See the reviews customers have sent in.', es: 'Mira las reseñas que enviaron los clientes.' },
    'biab.reviews.body': { en: 'After an invoice is saved, NALA asks that customer for a review automatically. Check this page to see the reviews that came in.', es: 'Después de guardar una factura, NALA le pide automáticamente una reseña a ese cliente. Revisa esta página para ver las reseñas recibidas.' },
    'biab.reviews.next': { en: 'To get a new review, go to Invoices and click Create a new invoice. Saving the invoice sends the review request.', es: 'Para recibir una nueva reseña, ve a Facturas y haz clic en Crear una factura nueva. Al guardar la factura se envía la solicitud de reseña.' },
    'biab.reviews.help': { en: 'New reviews appear here after customers answer the review request email.', es: 'Las reseñas nuevas aparecen aquí después de que los clientes respondan el correo de solicitud de reseña.' },
    'biab.genericSetupHelp': { en: 'This step is ready. Follow the instructions on this page, then click the main button when you are done.', es: 'Este paso está listo. Sigue las instrucciones de esta página y luego haz clic en el botón principal cuando termines.' },
    ...
    'settings.privacyDesc': { en: 'Enter the personal contact details NALA should use if we need to reach you. These details are for your account, not for customers.', es: 'Ingresa los datos personales que NALA debe usar si necesitamos contactarte. Estos datos son para tu cuenta, no para los clientes.' },
    'settings.privacyNext': { en: 'Fill in your name and email address, then click Save personal information.', es: 'Completa tu nombre y correo electrónico, y luego haz clic en Guardar información personal.' },
    ...
    'settings.savePersonal': { en: 'Save personal information', es: 'Guardar información personal' },
    'settings.saveBusiness': { en: 'Save business information', es: 'Guardar información del negocio' },
    'settings.saveServices': { en: 'Save services offered', es: 'Guardar servicios ofrecidos' },
    ...
    'settings.businessInfoDesc': { en: 'Enter the business details customers should see on your website, invoices, business card, and Google setup email.', es: 'Ingresa los datos del negocio que los clientes deben ver en tu sitio web, facturas, tarjeta y correo de configuración de Google.' },
    'settings.businessNext': { en: 'Fill in the required fields marked with an asterisk, then click Save business information. Next, open Services Offered.', es: 'Completa los campos obligatorios marcados con asterisco y luego haz clic en Guardar información del negocio. Después abre Servicios ofrecidos.' },
    ...
    'settings.servicesDesc': { en: 'Tell customers where you work and which locksmith services you offer.', es: 'Diles a los clientes dónde trabajas y qué servicios de cerrajería ofreces.' },
    'settings.servicesNext': { en: 'Enter your service area, check every service you offer, then click Save services offered.', es: 'Ingresa tu área de servicio, marca cada servicio que ofreces y luego haz clic en Guardar servicios ofrecidos.' },
    ...
    'settings.addService': { en: 'Add another service', es: 'Agregar otro servicio' },
    'settings.removeService': { en: 'Remove checked services', es: 'Eliminar servicios marcados' },
    'settings.serviceName': { en: 'Type the service name', es: 'Escribe el nombre del servicio' },
    'settings.help.fullName': { en: 'Use your real first and last name.', es: 'Usa tu nombre y apellido reales.' },
    'settings.help.emailAddress': { en: 'Use the email address where NALA can contact you.', es: 'Usa el correo donde NALA pueda contactarte.' },
    'settings.help.contactPhone': { en: 'Use a number where NALA can reach you if we need help with your setup.', es: 'Usa un número donde NALA pueda contactarte si necesitamos ayuda con tu configuración.' },
    'settings.help.password': { en: 'Your password is hidden. Click the eye icon if you need to see it.', es: 'Tu contraseña está oculta. Haz clic en el icono del ojo si necesitas verla.' },
    'settings.help.customerFacingName': { en: 'Enter the business name customers should see.', es: 'Ingresa el nombre del negocio que los clientes deben ver.' },
    'settings.help.legalName': { en: 'If your legal name is different from the customer-facing name, enter it here.', es: 'Si el nombre legal es diferente del nombre que ven los clientes, ingrésalo aquí.' },
    ...
    'settings.help.businessWebsite': { en: 'This is usually filled in automatically with your NALA website link.', es: 'Normalmente esto se completa automáticamente con el enlace de tu sitio de NALA.' },
    ...
    'settings.help.customServices': { en: 'Click Add another service to add one blank line. Type the service name and leave the box checked if you offer it.', es: 'Haz clic en Agregar otro servicio para añadir una línea en blanco. Escribe el nombre del servicio y deja la casilla marcada si lo ofreces.' },
    'settings.success.personalSaved': { en: 'Saved. Next, open Business Information and enter the details customers should see.', es: 'Guardado. Ahora abre Información del negocio e ingresa los datos que deben ver los clientes.' },
    'settings.success.businessSaved': { en: 'Saved. Next, open Services Offered and check the services you provide.', es: 'Guardado. Ahora abre Servicios ofrecidos y marca los servicios que prestas.' },
    'settings.success.servicesSaved': { en: 'Saved. Next, return to Business in a Box and choose the next setup step.', es: 'Guardado. Ahora vuelve a Negocio en una Caja y elige el siguiente paso de configuración.' },
  ...
  function translateLiteral(value) {
    ...
    for (var key in DICT) {
      if (Object.prototype.hasOwnProperty.call(DICT, key) && DICT[key] && (DICT[key].en === value || DICT[key].es === value)) {
        return DICT[key][_lang] || DICT[key].en || value;
      }
    }
    return value;
  }
