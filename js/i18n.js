...
(function (global) {
  ...
  var DICT = {
    ...
    'dashboard.gift.title': { en: 'Track your lockout kit', es: 'Rastrear tu kit de apertura' },
    'dashboard.gift.description': { en: 'View the status of your complimentary lockout kit order.', es: 'Consulta el estado del pedido de tu kit de apertura incluido.' },
    'dashboard.gift.pending': { en: 'Your complimentary lockout kit is tied to your Premium purchase. Tracking will appear here after the order is created.', es: 'Tu kit de apertura incluido está ligado a tu compra Premium. El rastreo aparecerá aquí cuando se cree el pedido.' },
    'dashboard.gift.trackShipment': { en: 'Track Shipment', es: 'Rastrear envío' },
    'dashboard.gift.viewOrder': { en: 'View Order Status', es: 'Ver estado del pedido' },
    'dashboard.lockpick.title': { en: 'Track your lockpick kit', es: 'Rastrear tu kit de ganzúas' },
    'dashboard.lockpick.description': { en: 'View the status of your Business in a Box lock pick tool set.', es: 'Consulta el estado del juego de ganzúas de tu paquete Negocio en una Caja.' },
    'dashboard.lockpick.pending': { en: 'Your lock pick tool set is tied to your Business in a Box purchase. Tracking will appear here after the order is created.', es: 'Tu juego de ganzúas está ligado a tu compra de Negocio en una Caja. El rastreo aparecerá aquí cuando se cree el pedido.' },
    ...
    'biab.googleSeo.desc': { en: 'Send yourself a simple email that explains how to approve the Google steps so customers can find the business more easily.', es: 'Envíate un correo sencillo que explica cómo aprobar los pasos de Google para que los clientes puedan encontrar el negocio más fácilmente.' },
    'biab.googleSeo.body': { en: 'Google setup helps connect the business website and business details to Google. Click Send Google setup email, then follow the simple instructions. NALA support will also get the business details needed for the next steps.', es: 'La configuración de Google ayuda a conectar el sitio web y los datos del negocio con Google. Haz clic en Enviar correo de configuración de Google y sigue las instrucciones sencillas. El soporte de NALA también recibirá los datos del negocio necesarios para los siguientes pasos.' },
    'biab.googleSeo.next': { en: 'Click Send Google setup email. Then open the email from NALA and follow the steps in order.', es: 'Haz clic en Enviar correo de configuración de Google. Luego abre el correo de NALA y sigue los pasos en orden.' },
    ...
    'biab.googleSearchConsoleAuthorizeThenSubmitDesc': { en: 'You approve Google access; then NALA can finish the Google website step for you.', es: 'Apruebas el acceso de Google; después NALA puede terminar el paso del sitio web en Google por ti.' },
    'biab.googleSearchConsoleAuthorizationDesc': { en: 'You have been emailed the Google setup steps. After you approve access, NALA can finish the Google website step for you.', es: 'Recibiste por correo los pasos de configuración de Google. Después de aprobar el acceso, NALA puede terminar el paso del sitio web en Google por ti.' },
    ...
    'biab.googleBusinessProfileVerificationDesc': { en: 'You have been asked to claim or verify the Business Profile and add NALA as a manager so we can help with the next steps.', es: 'Se te pidió reclamar o verificar el Perfil de Negocio y agregar a NALA como administrador para que podamos ayudar con los siguientes pasos.' },
    ...
    'biab.googleSeo.authorizationSent': { en: 'Google setup email sent. Open the email from NALA and follow each step in order.', es: 'Correo de configuración de Google enviado. Abre el correo de NALA y sigue cada paso en orden.' },
    ...
    'biab.googleSeo.statusHelp': { en: 'After you click the email button, the status below shows what is ready and what you still need to do.', es: 'Después de hacer clic en el botón de correo, el estado de abajo muestra qué está listo y qué necesitas hacer todavía.' },
    ...
    'biab.needsCustomerAction': { en: 'Needs your action', es: 'Requiere tu acción' },
    ...
    'biab.done': { en: 'Done', es: 'Listo' },
    'biab.notDoneYet': { en: 'Not done yet', es: 'Todavía no está listo' },
    ...
    'biab.serviceListingTemplateDesc': { en: 'Choose the locksmith services you offer in Profile & Settings. NALA uses that list on your website and business materials.', es: 'Elige los servicios de cerrajería que ofreces en Perfil y configuración. NALA usa esa lista en tu sitio web y materiales del negocio.' },
    ...
    'biab.googleWebsiteSetupDesc': { en: 'NALA prepares your website for Google. This is checked after the Google setup email is sent.', es: 'NALA prepara tu sitio para Google. Esto se marca después de enviar el correo de configuración de Google.' },
