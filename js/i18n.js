...
(function (global) {
  ...
  var DICT = {
    ...
    'biab.card.intro': { en: 'Twelve options are generated from curated layout, palette, typography, and icon rules so each card stays readable and balanced.', es: 'Se generan doce opciones con reglas curadas de diseño, paleta, tipografía e íconos para que cada tarjeta sea legible y equilibrada.' },
