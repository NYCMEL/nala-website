...
(function (global) {
  ...
  var DICT = {
    ...
    'biab.googleSeo.title': { en: 'Google SEO Automation', es: 'Automatización de SEO de Google' },
    'biab.googleSeo.label': { en: 'Google SEO', es: 'SEO de Google' },
    'biab.googleSeo.search': { en: 'Search', es: 'Búsqueda' },
    'biab.googleSeo.desc': { en: 'Prepare the hosted website, Search Console submission, and Google Business Profile data from the same business profile.', es: 'Prepara el sitio web alojado, el envío a Search Console y los datos del Perfil de Negocio de Google desde el mismo perfil comercial.' },
    'biab.googleSeo.body': { en: 'Click the button once to prepare the SEO package, email the client Google authorization instructions, notify NALA support, and start the Business Profile verification handoff.', es: 'Haz clic una vez para preparar el paquete de SEO, enviar al cliente las instrucciones de autorización de Google, avisar al soporte de NALA e iniciar el traspaso de verificación del Perfil de Negocio.' },
    ...
    'biab.googleSeo.preparedSuccess': { en: 'Google SEO package prepared.', es: 'Paquete de SEO de Google preparado.' },
    'biab.googleSeo.authorizationSent': { en: 'Google SEO authorization email sent. NALA has the profile data ready for verification steps.', es: 'Correo de autorización de SEO de Google enviado. NALA tiene los datos del perfil listos para los pasos de verificación.' },
    'biab.googleSeo.startAuthorization': { en: 'Send authorization email & start Google setup', es: 'Enviar correo de autorización e iniciar configuración de Google' },
    'biab.googleData': { en: 'Google-ready business data', es: 'Datos comerciales listos para Google' },
    ...
    'biab.websiteUrl': { en: 'Website Url', es: 'URL del sitio web' },
    'biab.sitemapUrl': { en: 'Sitemap Url', es: 'URL del mapa del sitio' },
    ...
    'settings.servicesDesc': { en: 'Manage your service areas and services offered.', es: 'Administra tus áreas de servicio y los servicios ofrecidos.' },
