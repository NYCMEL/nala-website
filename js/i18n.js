...
(function (global) {
  ...
  var DICT = {
    ...
    'biab.googleSeo.desc': { en: 'Send yourself a simple email that tells you exactly how to approve Google setup.', es: 'Envíate un correo sencillo que te dice exactamente cómo aprobar la configuración de Google.' },
    'biab.googleSeo.body': { en: 'Click Send Google setup email. You will get step-by-step instructions. NALA support will also get the business details needed for the next steps.', es: 'Haz clic en Enviar correo de configuración de Google. Recibirás instrucciones paso a paso. El soporte de NALA también recibirá los datos del negocio necesarios para los siguientes pasos.' },
    ...
    'biab.basicWebsiteStructureDesc': { en: 'NALA creates your website pages for you. After you save your business information, the website can use that information.', es: 'NALA crea las páginas de tu sitio para ti. Después de guardar la información del negocio, el sitio puede usar esa información.' },
    ...
    'biab.googleWebsiteSetupDesc': { en: 'NALA prepares your website for Google. You only need to approve Google access when the email arrives.', es: 'NALA prepara tu sitio para Google. Solo debes aprobar el acceso de Google cuando llegue el correo.' },
